2 POKE 53280,5
5 POKE 646,9 
7 F1=53281: W=1: POKE F1,W
8 print tab(6)"UDDDDDDDDDDDDDDDDDDDDDDDDDDI"
9 print tab(6)"G                          H"
10 print tab(6);"G     amazing program      H"
20 print tab(6);"G    creative computing    H"
25 print tab(6);"G  morristown, new jersey  H"
26 POKE 648, 4
28 print tab(6);"G  updated for c64 by jrj  H"
29 print tab(6)"G                          H"
30 print tab(6)"JFFFFFFFFFFFFFFFFFFFFFFFFFFK"
32 POKE 646, 4
33 print:print:print:print
43 print "i will make a unique maze for you."
48 print
53 print "tell me your desired dimensions."
100 input "what is the width";h
101 input "what is the length";v
...
1074 print
1075 POKE 646, 4
1076 print " S did you make it out of the maze? S"
1077 end